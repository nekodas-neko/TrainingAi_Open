...
## 2026-09-08 — `docs/implementation-backlog.md` → 18758 (LB-63 shipped)
...
18758 rather than the 18716 this branch computed: Q-112e's split landed underneath it and added 42.
The −17 is unchanged across that, which is why the number is recomputed from the merged file rather
than carried.
