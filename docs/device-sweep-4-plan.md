...
and the `--sittings` list (116 checks owed elsewhere) · **Target:** web v1.465.62 (prod = `main`),
APK on the phone 1.460.4 (the latest published APK is 1.465.52 — see the owner decisions).

Two sittings of about 2½ h each. **4a** needs nothing from the owner beyond plugging in. **4b** needs
...
## Sitting 4a — fixes and performance (no owner needed; ~2 h 30 min)
...
## Sitting 4b — gesture navigation and the long probes (~2 h 30 min)
