...
The next **seven** entries are the nutrition cluster, **ordered by dependency rather than Q number**.
(Q-399 was the eighth and **shipped 2026-08-18 in #163** — the centred label now has room for the
ingredient list it promises. Its entry was correctly removed on merge.)
