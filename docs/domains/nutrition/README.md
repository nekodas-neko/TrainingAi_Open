...
- 🔴 **The whole meal-plan write surface was dead, and is fixed** (Q-398, 2026-08-24, v1.339.0).
...
- ⚠️ **Plan meals become saved meals** (Q-398, 2026-08-24, v1.339.0) — `Save to My Meals` per meal
