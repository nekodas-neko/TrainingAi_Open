...
- [`docs/reviews/2026-09-08-walk-intensity-calibration.md`](../../reviews/2026-09-08-walk-intensity-calibration.md) — **Zone 2 is unreachable on foot, 2026-09-08 (TN-24) — and this is Q-523's mechanism.** `hr-zones.ts:38` gives **Z1 = 52–122 bpm, 60% of the usable range in one bucket**, so sitting still and a brisk interval walk score identically. **The max is genuine** (140 samples above 150, a real 168), so the zones are anchored right and the training simply never reaches them — nothing above 140 bpm since 2026-07-24. **Cadence is nearly exhausted as a lever:** across 88 intervals `corr(cadence, HR)` = **+0.512**, slope **0.288 bpm/spm**, so a **31% cadence separation buys 7.9 bpm** and reaching Z2 would need **≈198 spm**. Mean fast-interval intensity **40.1% of reserve** against Z2's 60%. **⛔ Do not lower the boundaries** — change what is reported (% of reserve), and prescribe a HR band with grade/load rather than a cadence target.
