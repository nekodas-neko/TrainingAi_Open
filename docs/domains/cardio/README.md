...
- [`docs/reviews/2026-09-08-walk-intensity-calibration.md`](../../reviews/2026-09-08-walk-intensity-calibration.md) — **the guided walk measured end to end, 2026-09-08/09** (TN-24, TN-25, TN-26, TN-30, TN-31, TN-32). The fast target of 133 bpm was met **0 of 44 times** and Zone 1 spans **52–132**, 60% of the range. Eight addenda, three of which **retract an earlier one** — read to the end before quoting a recommendation. Settled: the interval-walking protocol is sound and `hrReserveTarget(0.70, …)` implements it faithfully; what does not transfer is the population. **Duration, not cadence, is the lever** — the owner's 35-minute session raised fast blocks 97 → 116 bpm within the session on +11.7 spm, against a fitted prediction of +3.4. Owner decisions: max HR pinned at **178**, the walk keeps varied prescribed intervals against a **105–118 bpm** band, the jog moves to Run.
