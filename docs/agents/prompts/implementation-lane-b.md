...
`title: "🚧 Implementation Agent (B) 🟢"`, `model: "Opus 5"`, and `prompt` set to everything **below the `---`**
in `docs/agents/prompts/implementation-lane-b.md`. Omit everything else so the environment and permission mode
inherit from you.
