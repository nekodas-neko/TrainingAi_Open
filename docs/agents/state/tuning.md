...
**Updated:** 2026-08-18 · **By:** `tuning/heart-rate-calibration` · **Q band:** 500–529 (next free: 516)
...
| **heart-rate** | 🟡 **started 2026-08-18** — `HR_REST_THRESHOLD` done (**Q-515**: the boundary shrank 3× in a month because the owner got fitter; no fraction fixes it, the *anchoring* is the defect). **Still open: `PEAK_BANDS`** (its "stable per-bucket sample sizes" justification is an empirical claim nobody measured) **and the Karvonen zone boundaries** (0.6/0.7/0.8/0.9) |
