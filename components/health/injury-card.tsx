  ...
  return (
    <>
      <div className="rounded-2xl bg-muted/60 border border-border p-4">
        ...
        {/* Wrapped so `aria-controls` has one element to name — the rows are siblings, and an
            `aria-controls` pointing at the first of several describes the toggle wrongly. */}
        {showResolved && (
          <div id={resolvedId}>
            {resolved.map(i => (
