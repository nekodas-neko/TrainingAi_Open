  ...
  return (
    <div className="rounded-2xl bg-muted/40 border border-border p-4 space-y-2">
      ...
      <div className="flex gap-2 mt-2">
        <button onClick={handleReview} disabled={loading} className="tap-dense tap-target-44 text-xs bg-brand text-primary-foreground rounded-lg px-3 py-1.5 disabled:opacity-60">
