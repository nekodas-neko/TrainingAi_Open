...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    date: "2026-09-23",
    changes: [
      "Sleep times now follow your profile's timezone rather than the phone's. The Sleep screen's bedtime consistency was worked out in whatever zone the handset was set to, and the bedtime and wake charts always assumed Brisbane \u2014 so both could drift if you travelled. They read your profile setting now.",
    ],
  },
  {
    version: "1.465.11",
  ...
  },
  {
    ...
    date: "2026-09-23",
    changes: [
      "Moving between the main tabs from inside a screen \u2014 finishing a walk, saving a fitness test, tapping a day on the timeline \u2014 now switches tabs the way the tab bar does, instead of rebuilding all five screens from scratch. Fifteen places did it the slow way, including two on the home screen that sat on adjacent lines and behaved differently for no reason you could see.",
      "Home and More no longer overwrite each other's scroll position. Both stay loaded at once and were saving to the same slot, so returning to one could drop you where you had been in the other.",
    ],
  },
  {
    version: "1.465.8",
  ...
  },
  {
    ...
    date: "2026-09-02",
    changes: [
      "You can log half a meal or a meal and a half. Open a saved meal and there are three buttons \u2014 \u00bd\u00d7, 1\u00d7, 1\u00bd\u00d7 \u2014 above Log this meal, and the calories and macros on the sheet change with them, so what you see is what gets logged.",
      "It resets to a whole portion each time you open a meal, so it can never quietly log half of one because that is what you had yesterday.",
      "Scanning a label still logs one portion straight away without asking \u2014 that flow is for scanning and going.",
    ],
  },
  {
    version: "1.430.1",
  ...
  },
  {
    ...
    changes: [
      ...
      "When movement has earned something, the bar breaks it down \u2014 workouts, activity and steps \u2014 instead of showing one figure.",
  ...
  },
  {
    ...
    date: "2026-08-24",
    changes: [
      "The saved-meals list, the meal-plan cards and the ring debug log stop redrawing themselves when nothing about them changed. Each was wrapped in a re-render guard that a detail at the call site was quietly cancelling out, so the whole saved-meals list redrew on every keystroke elsewhere on the screen.",
    ],
  },
  {
    version: "1.348.0",
