...
// exists and is green on an unmerged PR, and it has to record what would make the risk live again.
  ...
  // Raised 2026-08-19 (Lane B, Q-359 ratchet): the entry stays — the ratchet ships, the sweep does
  // not. The added lines are two corrections a struck entry would have destroyed: the count was one
  // low (a scan that missed single-line effects), and the can-bite grouping was 14 when it is 19,
  // because the tab screens mount their sheets unconditionally with a null prop. "Judge by mount
  // site, not filename" is the reusable half, and it is wrong in the obvious direction.
  'docs/implementation-backlog.md': 10178,
