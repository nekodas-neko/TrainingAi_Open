...
const BASELINE = {
  ...
  // main's side, not spliced. The Nutrition tab shows two calorie budgets 274 apart, both
  // labelled "left": a fixed set goal, and maintenance minus the recomp adjustment, which moves
