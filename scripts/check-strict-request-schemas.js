...
//
// Eight more, 2026-08-24 (75 → 67): `workout-sessions`, `fitness-tests` (both single-field DELETE
// bodies with no in-repo client found — safe regardless), `exercise-gif`/`nutrition/barcode` (both
// GET routes whose schema validates an object the route BUILDS from `searchParams`, the "no client
