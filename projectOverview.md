...
| [`docs/overview/history-2026-08.md`](docs/overview/history-2026-08.md) | **Completed journal (batched)** — the 2026-09-01 compaction sweep, folding **22 of 250** loose entries (dated 2026-08-26 → 2026-08-29). Started as a new batch rather than appended, because `history-newest.md` was at 333 KB, past the ~250 KB per-file rule. **22 of 40 foldable, not all 40:** the sweep stopped at 2026-08-29 so the last two days stay a genuine recent window, and the other 210 entries are cited by path from `projectOverview.md`, a domain index or an agent baton — folding a cited entry breaks the citation. Took the directory 250 → 229, back under the 250 total ceiling that failed CI |
