...
| [`docs/overview/history-2026-08-24.md`](docs/overview/history-2026-08-24.md) … `history-2026-07-17.md` | **Completed journal (batched)** — ten files covering 2026-07-17 → 2026-08-18, folded from 498 + 41 loose entries by the 2026-08-17 and 2026-08-18 compaction sweeps, oldest-first within each. Every entry keeps a `<!-- from: … -->` marker naming the PR file it came from. `history-2026-08-18.md` was started because `history-2026-08-15.md` had passed the ~250 KB rule at 300 KB, and `history-2026-08-24.md` because `history-2026-08-18.md` had, at 326 KB. **The 2026-08-24 sweep folded 60 of 153 loose entries** — the other 93 are cited by path from `projectOverview.md`, the domain indexes or an agent baton, and folding a linked entry breaks those citations |
